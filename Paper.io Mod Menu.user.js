...
// @version      1.0
// @description  Mod Menu para o jogo Paper.io! Pressione "Iniciar Jogo" NO MOD MENU para que a alteração funcione!
// @author       LordF1T4
...
<div id="box">
    <div class="main" id="box2">
        <p style="color:white;"> MOD MENU </p>

        <section><label>Zoom [Scroll]</label></section>
        <section><label>Pausar [P]</label></section>
        <section><div class="dropdown"><button class="button">Skin [Passe o Mouse]</button>
        <div class="dropdown-content"><p id="skinbtn1">Sem Skin</p><p id="skinbtn2">Nyan Cat</p><p id="skinbtn3">Melancia</p><p id="skinbtn4">Pac Man Ghost</p><p id="skinbtn5">Pizza</p><p id="skinbtn6">Minion</p><p id="skinbtn7">Fred Fazbear</p><p id="skinbtn8">Spiderman</p></div>
        <div class="dropdown-content1"><p id="skinbtn9">TeleTubby</p><p id="skinbtn10">Unicornio</p><p id="skinbtn12">Coração</p><p id="skinbtn11">Coracao Arcoiris</p><p id="skinbtn13">Bat</p><p id="skinbtn14">Sushi</p><p id="skinbtn15">Dinheiro</p><p id="skinbtn16">Cake</p></div>
        <div class="dropdown-content2"><p id="skinbtn17">Bóia</p><p id="skinbtn18">Tanque</p><p id="skinbtn19">Ladybug</p><p id="skinbtn22">Arvore de Natal</p><p id="skinbtn20">Cheeseburger</p><p id="skinbtn21">Laranja</p><p id="skinbtn23">Present</p><p id="skinbtn24">Snowman</p></div>
        <div class="dropdown-content3"><p id="skinbtn25">Cupido</p><p id="skinbtn26">Thanos</p><p id="skinbtn28">Reaper</p><p id="skinbtn27">Captain America</p><p id="skinbtn29">Pennywise</p><p id="skinbtn30">Joker</p><p id="skinbtn31">Batman</p><p id="skinbtn32">Geralt</p></div>
        <div class="dropdown-content4"><p id="skinbtn33">Covid-19</p><p id="skinbtn34">Doutor</p><p id="skinbtn35">Sanitizer</p><p id="skinbtn36">Mascara</p><p id="skinbtn37">Cyberpunk</p><p id="skinbtn38">Xadres</p><p id="skinbtn39">Yoda</p></div>
        </section>
        <section><div class="dropdown"><button class="button" id="startButton">Iniciar Jogo</button></section>
        <br>
        <section><label>Cor da Arena:</label></section>
        <section><input type="color" id="arenaColor" value="#e7fff4"></input></section>
        <br>
        <section><label>Voar:</label></section>
        <section><label>TFGH = WASD</label></section>
        <br>
        <section><label>Velocidade:</label><input type="range" min="1" max="180" value="90" id="gsSlider"></section>
        <section><label id="gsValue">90</label></section>
        <p>M para Minimizar</p>
